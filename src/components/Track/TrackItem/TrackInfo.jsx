                ...
                <div className="row">
                    <div className="col-lg-4 col-12 text-center">
                        <div className="artist-info__img">
                            <img src={props.trackInfo.album ? Object.values(props.trackInfo.album.image[3])[0] : ''} alt=""/>
                        </div>
                    </div>
                    <div className="col-lg-8 col-12">
                        <div className="artist-info__descr">
                            ...
                            <p className='text-lg-left text-center' >Исполнитель: <NavLink to={props.trackInfo.artist.mbid ? `/artists/${props.trackInfo.artist.mbid}` : `#`} >{props.trackInfo.artist.name}</NavLink></p>
                            {props.trackInfo.album &&
                            <p className='text-lg-left text-center'>Альбом: <NavLink to={props.trackInfo.album.mbid ? `/albums/${props.trackInfo.album.mbid}` : `#`} >{props.trackInfo.album.title}</NavLink></p>
                            }
